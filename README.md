...
* `run_12ECG_classifier.m` makes predictions on clinical time-series data.  Add your prediction code to the `run_12ECG_classifier` function. It calls all the functions inside the `Tools` folder 
